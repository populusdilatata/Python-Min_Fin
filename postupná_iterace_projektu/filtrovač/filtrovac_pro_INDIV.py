...
FILTRAT = "vstup_f60/07A_DATA/f60_FILTER_INDIV.xlsx"
SLOUPEC = "oscis"
...
def kontrola(radek):
    if radek["appvdr"] in [210, 200] and radek["neo2dr"] == 158:
        return "splněno"
    elif radek["appvdr"] == 101 and radek["neo2dr"] == 52:
        return "splněno"
    else:
        return "nesplněno"
...
with pd.ExcelWriter("dochzarv2_06_FILTER_INDIV.xlsx", engine="openpyxl") as writer:
